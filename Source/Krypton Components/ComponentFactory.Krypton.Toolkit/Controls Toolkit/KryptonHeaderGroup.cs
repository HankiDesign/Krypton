...
namespace ComponentFactory.Krypton.Toolkit
{
    ...
    public class KryptonHeaderGroup : VisualControlContainment
    {
		...
		private readonly HeaderGroupValuesPrimary _headerValues1;
		private readonly HeaderGroupValuesSecondary _headerValues2;
        ...
        private readonly PaletteHeaderGroupRedirect _stateCommon;
        private readonly PaletteHeaderGroup _stateDisabled;
		private readonly PaletteHeaderGroup _stateNormal;
        private readonly HeaderGroupButtonSpecCollection _buttonSpecs;
