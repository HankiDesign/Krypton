...
namespace ComponentFactory.Krypton.Navigator
{
    ...
    public class KryptonPage : VisualPanel
    {
        ...
        private readonly PaletteNavigatorOtherEx _stateTracking;
        private readonly PaletteNavigatorOtherEx _statePressed;
        private readonly PaletteNavigatorOther _stateSelected;
        private readonly PaletteNavigatorOtherRedirect _stateFocus;
        private readonly NeedPaintHandler _needDisabledPaint;
        private readonly NeedPaintHandler _needNormalPaint;
        private readonly PageButtonSpecCollection _buttonSpecs;
