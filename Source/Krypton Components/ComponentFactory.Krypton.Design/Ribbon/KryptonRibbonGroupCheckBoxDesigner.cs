...
namespace ComponentFactory.Krypton.Ribbon
{
    internal class KryptonRibbonGroupCheckBoxDesigner : ComponentDesigner
    {
        ...
        {
	        if (_ribbonCheckBox?.Ribbon == null) return;
        ...
        private TypedRestrictCollection<KryptonRibbonGroupItem> ParentItems
        {
            get
            {
	            if (_ribbonCheckBox.RibbonContainer is KryptonRibbonGroupTriple triple)
                {
	                return triple.Items;
                }
	            if (_ribbonCheckBox.RibbonContainer is KryptonRibbonGroupLines lines)
	            {
		            return lines.Items;
	            }
	            // Should never happen!
